...
export const PlayerProgressBar = ({progressRef, playerRef, playAnimationRef}:{progressRef: any, playerRef: any, playAnimationRef:any}):JSX.Element => {
    ...
    return (
        <div className={'w-full flex gap-x-4 items-center justify-center max-w-[800px]'}>
            ...
            <ProgressBar playAnimationRef={playAnimationRef} playerRef={playerRef} progressRef={progressRef}/>
