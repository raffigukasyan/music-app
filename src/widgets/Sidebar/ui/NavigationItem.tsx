...
import { variantsElement, variantsItem } from '../consts/animation';
  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className={isActive ? 'text-myGreen' : 'text-myWhite'}
      >
        {route.title}
      </motion.span>
    </motion.div>
