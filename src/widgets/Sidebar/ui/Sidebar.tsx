...
export const Sidebar = ():JSX.Element => {
    ...
    return (
        <motion.div animate={isOpen ? 'visibility' : 'hidden'} className={'flex flex-col justify-between gap-y-7 h-full bg-[#22252B] py-8 px-4 rounded-2xl'}>
            <Logo/>
            ...
            <OpenButton onClick={() => setIsOpen(!isOpen)}>
                ...
                <motion.span  variants={variantsElement}>Свернуть</motion.span>
            </OpenButton>
